...
# @HELP generate openapi types from config-openapi3.yaml
oapi-codegen-config: oapi-codegen
	oapi-codegen -generate types -package collector -o pkg/collector/config-types.go api/config-openapi3.yaml
	sed -i '1i// Code generated by oapi-codegen. DO NOT EDIT.' pkg/collector/config-types.go
